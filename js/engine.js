...
var Engine = (function(global) {
    ...
    // print canvas-relative mouse clicks to console
    ...
    function checkCollisions() {
         ...
         * If there is a collision, call the heart.clear() method to 
         * clear the heart from the canvas and call the stats.updateHearts 
         * to update the hearts count and increase the lives by 1.
         */
        allHearts.forEach(function(heart) {
            if (collision(player, heart)) {

                heart.clear();
                player.updateLives('add', 1)
                stats.updateLives(player.lives);
